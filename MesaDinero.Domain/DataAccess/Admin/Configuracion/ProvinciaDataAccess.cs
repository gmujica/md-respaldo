...
namespace MesaDinero.Domain.DataAccess.Admin
{
    ...
    {
        public PageResultSP<ProvinciaResponse> getAllProvincia(PageResultParam param)
        {
            PageResultSP<ProvinciaResponse> result = new PageResultSP<ProvinciaResponse>();
            result.data = new List<ProvinciaResponse>();
            ...
            try
            {
                ...
                {
                    result.data = context.Database.SqlQuery<ProvinciaResponse>("exec Proc_Sel_Provincia @PageNumber,@ItemsPerPage", pageParam, itemsParam).ToList<ProvinciaResponse>();
        ...
        public BaseResponse<string> EditarProvincia(ProvinciaRequest model)
        {
            BaseResponse<string> result = new BaseResponse<string>();
