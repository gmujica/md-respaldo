...
var ViewModel = function () {
    ...
    this.init = function () {
        ...
        PostJson("common/getAllOrigenFondos", null, true).done(function (result) {
            ...
            PostJson("registro/getdatosPersona-init", data, false).done(function (result) {
                ...
                if (result.success == true) {
                    ...
                    if(result.data.pais)
                    {
                       // self.Persona.pais(result.data.pais);
                        ...
                        PostJson("common/getDepartatmentoXPais/" + self.Persona.pais(), null, false).done(function (result1) {
                            self.Persona.lstaDepartamento(result1.data);
                            $("#combo_departamento_persona").trigger('chosen:updated');
                        });
                    }
