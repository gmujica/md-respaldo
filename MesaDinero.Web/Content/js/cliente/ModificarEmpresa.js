...
function PersonaAutorizada() {
    ...
    this.indAutorSuperior = ko.observable();
...
function ViewModel() {
    ...
    this.modoEdicion = ko.observable();
    /* Persona Legal*/
    ...
    this.init = function () {
        ...
        PostJson("listar-datos-empresa", null).done(function (resultado) {
            ...
            if (resultado.success == true) {
                ...
                self.modoEdicion(datos.empresa.modoEdicion);
                ...
                datos.personaAutorizadas.forEach(function (elemento, index) {
                    debugger;
                    this.persona = new PersonaAutorizada();
                    ...
                    if (elemento.estado == 1) {
                        ...
                        this.persona.indAutorSuperior(index);
