    ...
    this.generarLiquidacion = function () {
        ...
        lista.forEach(function (elemento) {
            ...
            if (elemento.checkEstado) {
                ...
                this.subastaLiquidar.estado = "4"; /* Estado*/
        ...
        PostJson("liquidacion-aprueba-fideicomiso", model).done(function (result) {
            if (result.success == true) {
                debugger;
                self.init();
                toastr.success('Se aprobo liquidacion Correctamente');
                self.numeroLiquidar('');
