...
function PostJson(action, dataparams) {
    return ajaxMethodJson(action, 'POST', dataparams);
}


function PostJson2(action, dataparams) {
    return ajaxMethodJson2(action, 'POST', dataparams);
}
...
function ajaxMethodJson(action, method, params) {
...
function ajaxMethodJson2(action, method, params) {
...
function ajaxMethod(action, method, params, isMultipart) {
    var config = {
        method: method,
        url: window.urlApi + action,
        dataType: 'json',
