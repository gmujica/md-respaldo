...
namespace MesaDinero.Admin.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        {
            RegistroPassWpord_Response model = new RegistroPassWpord_Response();
        ...
        [HttpPost]
        public ActionResult ModificarUsuarioAdm(ModificarPassWord_Request model)
        {
            MesaDinero.Domain.BaseResponse<string> result = new MesaDinero.Domain.BaseResponse<string>();
            try
            {
                result.success = true;
                Domain.DataAccess.RegistroCliente _regsitroDataAccess = new Domain.DataAccess.RegistroCliente();
                MesaDinero.Domain.BaseResponse<string> result_ = _regsitroDataAccess.ModificarPasswprdAdm(model, CurrentNombreUsuario);
